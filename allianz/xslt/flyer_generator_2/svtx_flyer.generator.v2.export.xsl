<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="asset[@type='profession.']">
    <xsl:apply-templates select="cs:child-rel()[@key='user.']/cs:asset()[@censhare:asset.type='document.']" mode="export"/>
  </xsl:template>

  <xsl:template match="asset[@type='document.']" mode="export">
    ...
    <xsl:variable name="age" select="$profession/child_asset_rel[@key='user.' and @child_asset=$rootAsset/@id]/@sorting" as="xs:long?"/>
    <xsl:choose>
