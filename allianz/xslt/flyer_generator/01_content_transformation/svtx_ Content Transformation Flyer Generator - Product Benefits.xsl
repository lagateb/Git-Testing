...
<xsl:stylesheet
  ...
  <xsl:variable name="PSMapping">
    <map:entry element="headline" stylegroup="Vorteile" stylename="Vorteile_Headline"/>
    <!--<map:entry element="paragraph" stylegroup="Produktbeschreibung" stylename="Produktbeschreibung_Body"/>-->
    <map:entry element="bullet-list" stylegroup="Vorteile" stylename="Vorteile_Body"/>
  </xsl:variable>
  ...
  <xsl:template match="headline | bullet-list">
  ...
  <!-- -->
  <xsl:template match="item/headline" mode="icml-body">
    <bold><xsl:apply-templates mode="icml-body"/><xsl:text>: </xsl:text></bold>
  </xsl:template>
