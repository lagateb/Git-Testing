...
<xsl:stylesheet
  ...
  <xsl:variable name="PSMapping">
    <map:entry element="paragraph" stylename="Zielgruppe_Body_positiv"/>
  </xsl:variable>
  ...
  <xsl:variable name="content">
    ...
    <content>
      <xsl:apply-templates select="$contentXml/article/content/body/pro/bullet-list" mode="icml-content"/>
    </content>
  </xsl:variable>
