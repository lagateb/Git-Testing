...
<xsl:stylesheet
  ...
  <xsl:variable name="PSMapping">
    <map:entry element="headline" stylename="Funktionsgrafikquer_Headline"/>
  </xsl:variable>
  ...
  <xsl:variable name="content">
    ...
    <!-- TODO: Neue Editor Content XML auslesen -->
    <content>
  ...
  <xsl:template match="headline" mode="icml-content">
  	<headline><headline_style><xsl:apply-templates mode="icml-content"/></headline_style></headline>
  </xsl:template>
