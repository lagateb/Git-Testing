...
<xsl:stylesheet
  ...
  <xsl:variable name="CSMapping">
    <map:entry element="bold" stylename="{svtx:getCSMappingStyle($rootAsset, 'Copy_blau_Highlight')}"/>
    <map:entry element="paragraph_style" stylename="{svtx:getCSMappingStyle($rootAsset, 'Copy_blau')}"/>
  </xsl:variable>
  ...
  <xsl:template match="paragraph_style | bold">
